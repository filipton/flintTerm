...
object PaletteCatalog {
    ...
    fun settings(): List<PaletteEntry> = listOf(
        ...
        setting("Bold text is bright", "Draw bold in the light half of the palette, the way xterm does", Routes.SETTINGS_APPEARANCE),
        ...
        setting("Menu Ctrl+C is a raw interrupt", "The menu's control keys reach a program that has taken the keyboard over", Routes.SETTINGS_KEYBOARD),
        ...
        setting("Float when leaving", "Switching apps leaves the terminal in a small window", Routes.SETTINGS_SESSIONS),
        ...
        setting("Find hosts on this network", "Servers announcing SSH over mDNS appear under Nearby", Routes.SETTINGS_CONNECTIONS),
    ...
    fun actions(): List<PaletteEntry> = listOf(
        ...
        action("Recordings", "Watch a cast play back, read a log, share or delete one", Routes.RECORDINGS),
